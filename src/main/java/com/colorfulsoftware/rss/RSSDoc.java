 ...
 * factory methods to obtain instances of the RSS elements.
 * 
 * @author Bill Brown
 * 
 */
public final class RSSDoc {
	 ...
	 */
	public static Cloud buildCloud(List<Attribute> attributes)
			throws RSSpectException {
	...
	private static void writeRSSOutput(RSS rss, XMLStreamWriter writer,
		...
		rss = RSSDoc.buildRSS(RSSDoc.buildChannel(channel.getTitle(), channel
				.getLink(), channel.getDescription(), channel.getLanguage(),
				channel.getCopyright(), channel.getManagingEditor(), channel
						.getWebMaster(), channel.getPubDate(), channel
						.getLastBuildDate(), channel.getCategories(), RSSDoc
						.getRSSpectVersion(), channel.getDocs(), channel
				...
				channel.getRating(), channel.getTextInput(), channel
						...
						.getExtensions(), channel.getItems()), rss
				.getAttributes(), rss.getExtensions());
